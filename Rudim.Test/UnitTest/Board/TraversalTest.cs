...
namespace Rudim.Test.UnitTest.Board
{
    ...
    public class TraversalTest
    {
        ...
        [Theory]
        [InlineData(Helpers.StartingFEN, 406968, 7, 8)]
        [InlineData(Helpers.EndgameFEN, 144104, 36, 9)]
        [InlineData(Helpers.AdvancedMoveFEN, 2061996, 1750, 8)]
        [InlineData(Helpers.KiwiPeteFEN, 6107985, -42, 8)]
