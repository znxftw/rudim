...
namespace Rudim.Test.UnitTest.Board
{
    ...
    public class TacticsTest
    {
        ...
        [InlineData("7k/5K2/5P1p/3p4/6P1/3p4/8/8 w - - 0 1", "g4g5", Skip = "More Depth Needed")]
        [InlineData("8/6B1/p5p1/Pp4kp/1P5r/5P1Q/4q1PK/8 w - - 0 32", "h3h4", Skip = "More Depth Needed")]
        [InlineData("8/8/p1p5/1p5p/1P5p/8/PPP2K1p/4R1rk w - - 0 1", "e1f1", Skip = "More Depth Needed")]
        [InlineData("1q1k4/2Rr4/8/2Q3K1/8/8/8/8 w - - 0 1", "g5h6")]
