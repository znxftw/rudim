...
traversal_test_case!(traversal_starting_position, STARTING_FEN, 1905549, 19, 13);
traversal_test_case!(traversal_endgame_position, ENDGAME_FEN, 1152044, 83, 17);
traversal_test_case!(
