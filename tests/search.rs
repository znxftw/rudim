...
traversal_test_case!(traversal_starting, STARTING_FEN, 613663, 37, 13);
traversal_test_case!(traversal_endgame, ENDGAME_FEN, 271297, 343, 17);
traversal_test_case!(traversal_advanced, ADVANCED_MOVE_FEN, 5691674, 2597, 16);
