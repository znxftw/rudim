...
traversal_test_case!(traversal_starting_position, STARTING_FEN, 128868, 23, 9);
traversal_test_case!(traversal_endgame_position, ENDGAME_FEN, 169125, 37, 13);
traversal_test_case!(
...
traversal_test_case!(traversal_kiwi_pete_position, KIWI_PETE_FEN, 151369, -49, 8);
